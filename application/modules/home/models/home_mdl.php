...
class Home_mdl extends CI_Model{
	...
	public function message()
	{
	        ...
	        //clients mail
	        $admin_email="support@rupamcargopackers.com";
	        $this->email->to($client_email);
	        $this->email->from($admin_email);
	        $this->email->subject('Thanks for requesting a Quotation');
	        $this->email->message("Hi $client_email,<br> Thanks for requesting a Quotation from Abhiraj Packers & Movers <i>(https://sriabhirajpackers.com)</i>. We will get back to you soon.<br><br><br>Regards,<br>Rupam Cargo Packers And Movers ($admin_email)<br>
